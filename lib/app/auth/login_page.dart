...
import 'package:quickspecpro/app/auth/login_page_model.dart';
...
class LoginPageBuilder extends StatelessWidget {
  const LoginPageBuilder({Key key, this.onSignedIn})
      : super(key: key);
  final VoidCallback onSignedIn;

  static Future<void> show(BuildContext context) async {
    final navigator = Navigator.of(context);
    await navigator.pushNamed(Router.loginPageBuilder,
        arguments: LoginPageBuilderArguments(
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider<LoginPageModel>(
      create: (_) => LoginPageModel(auth: auth),
...
class _LoginPageState extends State<LoginPage> {
  ...
  LoginPageModel get model => widget.model;
  ...
  void _showSignInError(
      LoginPageModel model, PlatformException exception) {
